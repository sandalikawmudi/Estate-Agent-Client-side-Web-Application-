...
import img1 from "../assets/Images/Prop3/img1.jpg";
import img2 from "../assets/Images/Prop3/img2.jpg";
import img3 from "../assets/Images/Prop3/img3.jpg";
import img4 from "../assets/Images/Prop3/img4.jpg";
import img5 from "../assets/Images/Prop3/img5.jpg";

function PropertyPage3() {
  ...
  const property = {
    ...
    description: "Spacious four bedroom detached family house..."
  };
  ...
  return (
    <div className="wrapper">
      ...
      <div className="content-box">
        ...
        {activeTab === "floor" && <p>4 bedroom home layout</p>}
